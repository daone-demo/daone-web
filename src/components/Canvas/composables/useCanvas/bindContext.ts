...
export const BIND_KEYS = [
  ...
  'imageGridSplitSource', 'imageEraseSource', 'imageInpaintSource', 'imageExpandSource', 'imageDialoguePreviews', 'imageDialoguePreviewUrl', 'imageDialogueWorkflowDisabled', 'showNodeToolbar', 'showMultiSelectToolbar',
